...
EMBEDDING_SIZE       = 256
MIN_FACES_PER_PERSON = 20  # Min num of samples per class - or class is removed
MAX_FACES_PER_PERSON = 25  # Max num of samples per class - additional samples are removed
MIN_FACES_UNSAMPLE   = 20  # All classes with lower num of samples are upscaled to this num of samples
